...
namespace ReadDataFromArduino
{
    ...
    {
        public static int GetDataInvalTime = 1000*60; //获取数据的时间间隙
        public static int SaveDataInvalTime = 1800000;  //保存数据的时间间隙
        public static int ShowDataInvalTime = 1000*60*10;   //显示数据的时间间隙
        public static int ComputDataCount = 5;   //计算一次平均值的数据量，并在label4显示
        ...
        {
            int indexTime = ComputDataCount;//多少个数据计算一次平均值，根据ShowDataInvalTime设置            
